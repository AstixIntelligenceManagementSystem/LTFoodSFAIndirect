...
public class DialogDayEndSummaryActivity extends Activity
{
    ...
    TableLayout tblLayout_withBtns;
    Button btn_done;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tblLayout_withBtns= (TableLayout) findViewById(R.id.tblLayout_withBtns);
        tblLayout_withBtns.setVisibility(View.GONE);
...
*/
    ...
    public void setUpVariable()
    {
        ...
        btn_Target_Achieved_Report.setOnClickListener(new View.OnClickListener()
        {
            @Override
        ...
        btn_sku_wise.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        btn_store_wise.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        btn_str_sku_wise.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        btn_mtd_sku_wise.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        btn_mtd_store_wise.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        btn_mtd_str_sku_wise.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
