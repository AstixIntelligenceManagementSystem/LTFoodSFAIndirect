...
public class LastVisitDetails extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		fullTS = df.format(dateobj);
		    ...
		    TextView storeName = (TextView)findViewById(R.id.txt_storeSummary);
		TextView tv_outstandingvalue= (TextView)findViewById(R.id.tv_outstandingvalue);
		...
		tv_outstandingvalue.setText("Rs.  "+outstandingvalue);
...
final Button btn_Cancel=(Button) findViewById(R.id.btn_Cancel);
		...
		Button but_Competitor = (Button)findViewById(R.id.but_Competitor);


		but_Competitor.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub

				Intent intent=new Intent(LastVisitDetails.this,FeedbackCompetitorActivity.class);
